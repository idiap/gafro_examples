...
ee_target_sphere = panda.getEEMotor(panda.getRandomConfiguration()).apply(
    Sphere(Point(), Point(1.0, 0.0, 0.0), Point(0.0, 1.0, 0.0), Point(0.0, 0.0, 1.0))
)

cost_function = SingleManipulatorTarget(panda, Point(), ee_target_sphere)
...
print("------------------------------------------------------")
print(f"Target Sphere:  {ee_target_sphere}")
