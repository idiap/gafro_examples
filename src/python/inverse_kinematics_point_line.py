...
ee_target_line = panda.getEEMotor(panda.getRandomConfiguration()).apply(Line(Point(), Point(0.0, 1.0, 0.0)))

cost_function = SingleManipulatorTarget(panda, Point(), ee_target_line)
