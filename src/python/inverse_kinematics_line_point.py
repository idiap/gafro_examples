...
line = Line(Point(), Point(0.0, 1.0, 0.0))
ee_target_point = panda.getEEMotor(panda.getRandomConfiguration()).apply(Point())

cost_function = SingleManipulatorTarget(panda, line, ee_target_point)
...
print("------------------------------------------------------")
print(f"Target Point:  {ee_target_point}")
print(f"Solution Line: {panda.getEEMotor(x).apply(line)}")
