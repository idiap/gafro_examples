...
line = Line(Point(), Point(0.0, 0.0, 1.0))
ee_target_line = Line(Point(1.0, 5.0, 0.0), Point(0.0, 6.0, 1.0))

cost_function = SingleManipulatorDualTarget(panda, line, ee_target_line)
...
print("------------------------------------------------------")
print(f"Target Line:   {ee_target_line}")
