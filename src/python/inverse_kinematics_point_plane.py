...
ee_target_plane = panda.getEEMotor(panda.getRandomConfiguration()).apply(
    Plane(Point(), Point(1.0, 0.0, 0.0), Point(0.0, 1.0, 0.0))
)

cost_function = SingleManipulatorTarget(panda, Point(), ee_target_plane)
...
print("------------------------------------------------------")
print(f"Target Plane:   {ee_target_plane}")
