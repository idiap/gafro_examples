...
ee_target_circle = panda.getEEMotor(panda.getRandomConfiguration()).apply(
    Circle(Point(), Point(1.0, 0.0, 0.0), Point(0.0, 1.0, 0.0))
)
...
print("------------------------------------------------------")
print(f"Target Circle:  {ee_target_circle}")
