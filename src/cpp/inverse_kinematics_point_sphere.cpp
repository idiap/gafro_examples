...
int main(int /*argc*/, char ** /*argv*/)
{
    ...
    gafro::Sphere<double> ee_target_sphere = panda.getEEMotor(panda.getRandomConfiguration())
                                               .apply(gafro::Sphere<double>(gafro::Point<double>(),               //
                                                                            gafro::Point<double>(1.0, 0.0, 0.0),  //
                                                                            gafro::Point<double>(0.0, 1.0, 0.0),  //
                                                                            gafro::Point<double>(0.0, 0.0, 1.0)));

    gafro::SingleManipulatorTarget<double, 7, gafro::Point, gafro::Sphere> cost_function(&panda, gafro::Point<double>(), ee_target_sphere);
    ...
    std::cout << "------------------------------------------------------" << std::endl;
    std::cout << "Target Sphere: " << ee_target_sphere << std::endl;
    std::cout << "Solution Point: " << panda.getEEMotor(x).apply(gafro::Point<double>()) << std::endl;
}