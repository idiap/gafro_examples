...
int main(int /*argc*/, char ** /*argv*/)
{
    ...
    gafro::Line<double> line(gafro::Point<double>(), gafro::Point<double>(0.0, 0.0, 1.0));
    gafro::Line<double> ee_target_line(gafro::Point<double>(1.0, 5.0, 0.0), gafro::Point<double>(0.0, 6.0, 1.0));

    gafro::SingleManipulatorDualTarget<double, 7, gafro::Line, gafro::Line> cost_function(&panda, line, ee_target_line);
