...
int main(int /*argc*/, char ** /*argv*/)
{
    ...
    gafro::PointPair<double> ee_target_pointpair =
      panda.getEEMotor(panda.getRandomConfiguration()).apply(gafro::PointPair<double>(gafro::Point<double>(), gafro::Point<double>(1.0, 0.0, 0.0)));

    gafro::SingleManipulatorTarget<double, 7, gafro::Point, gafro::PointPair> cost_function(&panda, gafro::Point<double>(), ee_target_pointpair);
    ...
    std::cout << "------------------------------------------------------" << std::endl;
    std::cout << "Target PointPair: " << ee_target_pointpair << std::endl;
