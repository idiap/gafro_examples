...
int main(int /*argc*/, char ** /*argv*/)
{
    ...
    gafro::Line<double> ee_target_line =
      panda.getEEMotor(panda.getRandomConfiguration()).apply(gafro::Line<double>(gafro::Point<double>(), gafro::Point<double>(0.0, 1.0, 0.0)));

    gafro::SingleManipulatorTarget<double, 7, gafro::Point, gafro::Line> cost_function(&panda, gafro::Point<double>(), ee_target_line);
    ...
    std::cout << "------------------------------------------------------" << std::endl;
    std::cout << "Target Line: " << ee_target_line << std::endl;
