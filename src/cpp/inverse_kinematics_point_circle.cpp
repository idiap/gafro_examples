...
int main(int /*argc*/, char ** /*argv*/)
{
    ...
    gafro::Circle<double> ee_target_circle = panda.getEEMotor(panda.getRandomConfiguration())
                                               .apply(gafro::Circle<double>(gafro::Point<double>(),               //
                                                                            gafro::Point<double>(1.0, 0.0, 0.0),  //
                                                                            gafro::Point<double>(0.0, 1.0, 0.0)));

    gafro::SingleManipulatorTarget<double, 7, gafro::Point, gafro::Circle> cost_function(&panda, gafro::Point<double>(), ee_target_circle);
    ...
    std::cout << "------------------------------------------------------" << std::endl;
    std::cout << "Target Circle: " << ee_target_circle << std::endl;
