...
int main(int /*argc*/, char ** /*argv*/)
{
    ...
    gafro::Plane<double> ee_target_plane = panda.getEEMotor(panda.getRandomConfiguration())
                                             .apply(gafro::Plane<double>(gafro::Point<double>(),               //
                                                                         gafro::Point<double>(1.0, 0.0, 0.0),  //
                                                                         gafro::Point<double>(0.0, 1.0, 0.0)));

    gafro::SingleManipulatorTarget<double, 7, gafro::Point, gafro::Plane> cost_function(&panda, gafro::Point<double>(), ee_target_plane);
    ...
    std::cout << "------------------------------------------------------" << std::endl;
    std::cout << "Target Plane: " << ee_target_plane << std::endl;
